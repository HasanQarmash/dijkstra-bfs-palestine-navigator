...
void dijkstra(int ArrayOFNameCitise[MAX_CITIES][MAX_CITIES],int NumberofCities,int sourseNode,int destinationIndex,int B[])
{
...
if(i!=sourseNode)
{
    ...
    {
       printf("\Shortest path (by Dijkstra method\)");
       printf("\nDestination City %s = %d ",city_list[i],dist[i]);
       printf("Path=%s",city_list[i]);
       j=i;
        do
          {
 ...
 int sourceIndex = -1;
    ...
    printf("                          4.Exit and print shortest path\n");
        ...
        if (choice == 1) {
            ...
            {
                printf("\n------------------------------------\n");
                dijkstra(distances,15,sourceIndex,destinationIndex,B);
                printf("\n------------------------------------\n");
